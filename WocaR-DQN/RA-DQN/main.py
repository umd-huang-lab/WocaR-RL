...
from train import train, wocar_train
...
parser.add_argument('--wocar',
                   dest='wocar',
                   action='store_true',
                   help='train the worst-case robust agent')
parser.add_argument(
    '--worst-ratio',
    type=float,
    default=0.05,
    help='ratio of worst-case q value')
parser.add_argument(
    '--worst-rate',
    type=int,
    default=10,
    help='worst model training frequency')
parser.add_argument(
    '--load-path',
    type=str,
    default=None,
...
if __name__ == '__main__':
    ...
    worst_model = CnnDQN(env.observation_space.shape[0], env.action_space)
    ...
    print("env_shape", env.observation_space.shape)
    ...
    wocar_train(curr_model, target_model, worst_model, env, optimizer, worst_optimizer, args)
